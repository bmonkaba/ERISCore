...
void ExtADCConfig(){
  ...
  //Wire.endTransmission(I2C_STOP);
  Wire.beginTransmission(74);Wire.write(1);Wire.write(6); //6 * 0.5db = 3db gain
  Wire.endTransmission(I2C_STOP);
  Wire.beginTransmission(74);Wire.write(2);Wire.write(6);
  Wire.endTransmission(I2C_STOP);
  Wire.beginTransmission(74);Wire.write(3);Wire.write(6);
  Wire.endTransmission(I2C_STOP);
  Wire.beginTransmission(74);Wire.write(4);Wire.write(6);
  Wire.endTransmission(I2C_STOP);
}
