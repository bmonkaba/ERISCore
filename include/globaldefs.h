...
#define DISPLAY_UPDATE_PERIOD  35
#define APPMANAGER_MONITOR_DD_UPDATE_RATE_MSEC 1 
...
//AppSCI
#define SERIAL_POLLING_RATE_MAX 16
...
#define SERIAL_AUTO_TRANSMIT_DATA_PERIOD 500
