...
class App {
    ...
    spiral() {
        ...
        var peak = Data.read("INPUT_PEAK")/100
        ...
        for (i in 1...(16)) {
            r = peak + ((r*0.33 + dr*0.66) * (0.5))
            g = (g*0.33 + dg*0.66) * 0
            b = peak + ((b*0.33 + db*0.66) * (0.5))
    ...
    render() {
        ...
        Draw.setCursor(6 + __x,__y -8)
        Draw.print("WREN VM")
        Draw.setCursor(4 + __x,__y -10)
        Draw.print("WREN VM")
        Draw.setCursor(6 + __x,__y -10)
        Draw.print("WREN VM")
        Draw.setCursor(4 + __x,__y -8)
        Draw.print("WREN VM")
        
        Draw.setTextColor(180,__x/1.9,(80)%200)
