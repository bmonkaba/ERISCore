...
class App {
    ...
    spiral() {
        ...
        if((x%15)==0 && (y%15)==0) Draw.line(x,y,__w,__h,(_count)%220,0,(_count * _theta)%220)
        Draw.setPixel(x,y,(x)%220,(_count * _theta)%220,y%220)
    ...
    updateRT() {
        ...
        if (_count > 1500){
            ...
            if (_demo_loops == 0 &&  Data.read("DEMO_MODE") == 1) App.restartVM("example_14")
        }
    }
    update() {
