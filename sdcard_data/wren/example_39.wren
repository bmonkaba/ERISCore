...
class App {
    construct new() {
        ...
        //load graphics from the SD card to the ram drive
        FileSystem.format()
        FileSystem.importFromSD("/I/U/S/PROTO/DARK/","texture_10.ile","/","spheres.ile")
        FileSystem.importFromSD("/I/U/S/ARCADE/PARALLAX/MOUNTAINS","glacial_mountains.ile","/","glacial_mountains.ile")
        FileSystem.importFromSD("/I/U/S/TOON/POLY/","Ground-02_nz2.ile","/","ground.ile")
        FileSystem.importFromSD("/I/U/S/UI/WenrexaUI/","MainPanel03_nz2.ile","/","panel.ile")
        FileSystem.importFromSD("/I/U/S/SIDE/DAWN/","2.ile","/","sky.ile")
        ...
        _size = Draw.getImageSize("","glacial_mountains.ile")
        _count = 0
        _blt_op = 0
        _demo_loops = 10
        __dx = 0
    ...
    update() {
        ...
        if (_count > 2900){
            ...
            System.print(FileSystem.exists("glacial_mountains.ile"))
    ...
    render() {
        ...
        Draw.useWrenFileSystem()
        Draw.loadImage("/","sky.ile",__dx/9,0,0)
        Draw.loadImage("/","glacial_mountains.ile",__dx/4,-30,_blt_op)
        Draw.loadImage("/","glacial_mountains.ile",_size[0] + __dx/4,-30,_blt_op)
        for (x in 0...(18)) {
            Draw.loadImage("/","ground.ile",__dx + (x * 120),165,0)
        }
        ...
        Draw.useWrenFileSystem()
        Draw.loadImage("/","panel.ile",40,200,0)
        Draw.useSDFileSystem()
        Draw.setCursor(55,208)
        Draw.print("Mountain RAM Drive BLT operation:")
        Draw.setCursor(55,220)
