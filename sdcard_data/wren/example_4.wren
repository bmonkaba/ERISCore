...
class App {
    ...
    spiral() {
        ...
        Draw.line(x,y,x+offset,y+offset,offset*x%220,offset*_theta%220,offset*y%220)
    ...
    update() {
        ...
        if (_count > 15000){
            ...
            if (_demo_loops == 0 &&  Data.read("DEMO_MODE") == 1) App.restartVM("example_5")
