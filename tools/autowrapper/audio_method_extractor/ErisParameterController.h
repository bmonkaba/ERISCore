...
void messageHandler(AppBaseClass *sender, const char *message){
    ...
    if(0){}else if(strncmp(gPC_ERISAUDIOANALYZEFFT1024,c,sizeof(gPC_ERISAUDIOANALYZEFFT1024)) == 0 &&\
        ...
        strcpy(objName,erisAudioAnalyzeFFT1024::short_name);
        ...
        if (eac != NULL){
			uint32_t binNumber;
            total_read = sscanf(p, "%f" , binNumber); // ['uint32_t binNumber']
            eac->read(binNumber);
        }
    }else if(strncmp(gPC_ERISAUDIOANALYZEFFT1024,c,sizeof(gPC_ERISAUDIOANALYZEFFT1024)) == 0 &&\
        strncmp(gPM_READ,m,sizeof(gPM_READ)) == 0){
        ...
        if (eac != NULL){
			uint32_t binFirst;
			uint32_t binLast;
            total_read = sscanf(p, "%f,%f" , binFirst,binLast); // ['uint32_t binFirst', 'uint32_t binLast']
        ...
        if (eac != NULL){
			uint8_t n;
            total_read = sscanf(p, "%d" , n); // ['uint8_t n']
        ...
        strncmp(gPM_AVAILABLE,m,sizeof(gPM_AVAILABLE)) == 0){
        strcpy(objName,erisAudioAnalyzeFFT256::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        ...
        strcpy(objName,erisAudioAnalyzeNoteFrequency::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        ...
        strncmp(gPM_AVAILABLE,m,sizeof(gPM_AVAILABLE)) == 0){
        strcpy(objName,erisAudioAnalyzePeak::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        ...
        strcpy(objName,erisAudioAnalyzePrint::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        ...
        strncmp(gPM_AVAILABLE,m,sizeof(gPM_AVAILABLE)) == 0){
        strcpy(objName,erisAudioAnalyzeRMS::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        ...
        strcpy(objName,erisAudioAnalyzeToneDetect::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        ...
        if (eac != NULL){
			...
			uint16_t cycles;
			uint16_t len;
            total_read = sscanf(p, "%f,%d,%d" , coef,cycles,len); // ['int32_t coef', 'uint16_t cycles', 'uint16_t len']
        ...
        strncmp(gPM_BEGIN,m,sizeof(gPM_BEGIN)) == 0){
        strcpy(objName,erisAsyncAudioInputSPDIF3::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        ...
        strcpy(objName,erisAudioControlCS42448::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        erisAudioControlCS42448* eac = (erisAudioControlCS42448*) (ad->getAudioStreamObjByName(objName));
        if (eac != NULL){
			uint8_t addr;
            total_read = sscanf(p, "%d" , addr); // ['uint8_t addr']
            eac->setAddress(addr);
        }
    }else if(strncmp(gPC_ERISAUDIOCONTROLCS42448,c,sizeof(gPC_ERISAUDIOCONTROLCS42448)) == 0 &&\
        ...
        if (eac != NULL){
			uint32_t n;
            total_read = sscanf(p, "%f" , n); // ['uint32_t n']
            eac->volumeInteger(n);
        }
    }else if(strncmp(gPC_ERISAUDIOCONTROLCS42448,c,sizeof(gPC_ERISAUDIOCONTROLCS42448)) == 0 &&\
        strncmp(gPM_VOLUMEINTEGER,m,sizeof(gPM_VOLUMEINTEGER)) == 0){
        ...
        if (eac != NULL){
			int16_t channel;
			uint32_t n;
            total_read = sscanf(p, "%f,%f" , channel,n); // ['int channel', 'uint32_t n']
        ...
        if (eac != NULL){
			int32_t n;
            total_read = sscanf(p, "%f" , n); // ['int32_t n']
        ...
        if (eac != NULL){
			int16_t chnnel;
			int32_t n;
            total_read = sscanf(p, "%f,%f" , chnnel,n); // ['int chnnel', 'int32_t n']
        ...
        if (eac != NULL){
			uint32_t address;
			uint32_t data;
            total_read = sscanf(p, "%f,%f" , address,data); // ['uint32_t address', 'uint32_t data']
            eac->write(address,data);
        }
    }else if(strncmp(gPC_ERISAUDIOCONTROLCS4272,c,sizeof(gPC_ERISAUDIOCONTROLCS4272)) == 0 &&\
        strncmp(gPM_ENABLE,m,sizeof(gPM_ENABLE)) == 0){
        strcpy(objName,erisAudioControlCS4272::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        ...
        if (eac != NULL){
			uint32_t reg;
			uint32_t val;
            total_read = sscanf(p, "%f,%f" , reg,val); // ['uint32_t reg', 'uint32_t val']
            eac->write(reg,val);
        }
    }else if(strncmp(gPC_ERISAUDIOCONTROLCS4272,c,sizeof(gPC_ERISAUDIOCONTROLCS4272)) == 0 &&\
        strncmp(gPM_VOLUMEINTEGER,m,sizeof(gPM_VOLUMEINTEGER)) == 0){
        ...
        strncmp(gPM_SETADDRESS,m,sizeof(gPM_SETADDRESS)) == 0){
        strcpy(objName,erisAudioControlSGTL5000::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        erisAudioControlSGTL5000* eac = (erisAudioControlSGTL5000*) (ad->getAudioStreamObjByName(objName));
        if (eac != NULL){
			uint8_t level;
            total_read = sscanf(p, "%d" , level); // ['uint8_t level']
        ...
        if (eac != NULL){
			uint32_t dB;
            total_read = sscanf(p, "%f" , dB); // ['uint32_t dB']
            eac->micGain(dB);
        }
    }else if(strncmp(gPC_ERISAUDIOCONTROLSGTL5000,c,sizeof(gPC_ERISAUDIOCONTROLSGTL5000)) == 0 &&\
        ...
        if (eac != NULL){
			uint8_t left;
			uint8_t right;
            total_read = sscanf(p, "%d,%d" , left,right); // ['uint8_t left', 'uint8_t right']
        ...
        if (eac != NULL){
            ...
            total_read = sscanf(p, "%f" , freqMCLK_in); // ['uint32_t freqMCLK_in']
        ...
        if (eac != NULL){
			uint32_t reg;
            total_read = sscanf(p, "%f" , reg); // ['uint32_t reg']
            eac->read(reg);
        }
    }else if(strncmp(gPC_ERISAUDIOCONTROLSGTL5000,c,sizeof(gPC_ERISAUDIOCONTROLSGTL5000)) == 0 &&\
        strncmp(gPM_WRITE,m,sizeof(gPM_WRITE)) == 0){
        ...
        if (eac != NULL){
			...
			uint32_t val;
			uint32_t iMask;
            total_read = sscanf(p, "%f,%f,%f" , reg,val,iMask); // ['uint32_t reg', 'uint32_t val', 'uint32_t iMask']
        ...
        if (eac != NULL){
			uint8_t dap;
			uint8_t eq;
            total_read = sscanf(p, "%d,%d" , dap,eq); // ['uint8_t dap', 'uint8_t eq']
            eac->automate(dap,eq);
        }
    }else if(strncmp(gPC_ERISAUDIOCONTROLSGTL5000,c,sizeof(gPC_ERISAUDIOCONTROLSGTL5000)) == 0 &&\
        strncmp(gPM_AUTOMATE,m,sizeof(gPM_AUTOMATE)) == 0){
        ...
        if (eac != NULL){
			...
			uint8_t eq;
			uint8_t filterCount;
            total_read = sscanf(p, "%d,%d,%d" , dap,eq,filterCount); // ['uint8_t dap', 'uint8_t eq', 'uint8_t filterCount']
        ...
        strncmp(gPM_ENABLE,m,sizeof(gPM_ENABLE)) == 0){
        strcpy(objName,erisAudioControlTLV320AIC3206::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        ...
        if (eac != NULL){
			uint8_t page;
			uint8_t reg;
            total_read = sscanf(p, "%d,%d" , page,reg); // ['uint8_t page', 'uint8_t reg']
        ...
        if (eac != NULL){
			...
			uint8_t reg;
			uint8_t val;
            total_read = sscanf(p, "%d,%d,%d" , page,reg,val); // ['uint8_t page', 'uint8_t reg', 'uint8_t val']
        ...
        if (eac != NULL){
			...
			float cutoff_Hz;
			float fs_Hz;
            total_read = sscanf(p, "%d,%f,%f" , enable,cutoff_Hz,fs_Hz); // ['bool enable', 'float cutoff_Hz', 'float fs_Hz']
        ...
        if (eac != NULL){
			uint16_t address;
			uint8_t val;
            total_read = sscanf(p, "%d,%d" , address,val); // ['uint16_t address', 'uint8_t val']
        ...
        strncmp(gPM_ENABLE,m,sizeof(gPM_ENABLE)) == 0){
        strcpy(objName,erisAudioControlWM8731master::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        ...
        strcpy(objName,erisAudioEffectChorus::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        ...
        strcpy(objName,erisAudioEffectDigitalCombine::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        ...
        strcpy(objName,erisAudioEffectDelay::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        erisAudioEffectDelay* eac = (erisAudioEffectDelay*) (ad->getAudioStreamObjByName(objName));
        if (eac != NULL){
			uint8_t channel;
			float milliseconds;
            total_read = sscanf(p, "%d,%f" , channel,milliseconds); // ['uint8_t channel', 'float milliseconds']
        ...
        if (eac != NULL){
			uint8_t channel;
            total_read = sscanf(p, "%d" , channel); // ['uint8_t channel']
            eac->disable(channel);
        }
    }else if(strncmp(gPC_ERISAUDIOEFFECTDELAY,c,sizeof(gPC_ERISAUDIOEFFECTDELAY)) == 0 &&\
        ...
        strncmp(gPM_DELAY,m,sizeof(gPM_DELAY)) == 0){
        strcpy(objName,erisAudioEffectDelayExternal::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        ...
        if (eac != NULL){
			uint32_t samples;
            total_read = sscanf(p, "%f" , type,samples); // ['AudioEffectDelayMemoryType_t type', 'uint32_t samples']
        ...
        if (eac != NULL){
			uint32_t address;
			uint32_t count;
            total_read = sscanf(p, "%f,%f" , address,count); // ['uint32_t address', 'uint32_t count']
        ...
        strcpy(objName,erisAudioEffectEnvelope::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        ...
        strcpy(objName,erisAudioEffectFade::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        erisAudioEffectFade* eac = (erisAudioEffectFade*) (ad->getAudioStreamObjByName(objName));
        if (eac != NULL){
			uint32_t milliseconds;
            total_read = sscanf(p, "%f" , milliseconds); // ['uint32_t milliseconds']
        ...
        if (eac != NULL){
			uint32_t newrate;
			uint8_t dir;
            total_read = sscanf(p, "%f,%d" , newrate,dir); // ['uint32_t newrate', 'uint8_t dir']
            eac->fadeBegin(newrate,dir);
        }
    }else if(strncmp(gPC_ERISAUDIOEFFECTFLANGE,c,sizeof(gPC_ERISAUDIOEFFECTFLANGE)) == 0 &&\
        strncmp(gPM_VOICES,m,sizeof(gPM_VOICES)) == 0){
        strcpy(objName,erisAudioEffectFlange::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        ...
        strcpy(objName,erisAudioEffectFreeverb::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        ...
        strncmp(gPM_ROOMSIZE,m,sizeof(gPM_ROOMSIZE)) == 0){
        strcpy(objName,erisAudioEffectFreeverbStereo::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        ...
        strcpy(objName,erisAudioEffectGranular::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        ...
        strcpy(objName,erisAudioEffectReverb::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        ...
        strcpy(objName,erisAudioFilterFIR::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        ...
        strcpy(objName,erisAudioFilterLadder::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        ...
        strncmp(gPM_FREQUENCY,m,sizeof(gPM_FREQUENCY)) == 0){
        strcpy(objName,erisAudioFilterStateVariable::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        ...
        strncmp(gPM_BEGIN,m,sizeof(gPM_BEGIN)) == 0){
        strcpy(objName,erisAudioInputI2S::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        ...
        strncmp(gPM_BEGIN,m,sizeof(gPM_BEGIN)) == 0){
        strcpy(objName,erisAudioInputI2Sslave::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        ...
        strncmp(gPM_BEGIN,m,sizeof(gPM_BEGIN)) == 0){
        strcpy(objName,erisAudioInputI2S2::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        ...
        strncmp(gPM_BEGIN,m,sizeof(gPM_BEGIN)) == 0){
        strcpy(objName,erisAudioInputI2S2slave::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        ...
        strncmp(gPM_BEGIN,m,sizeof(gPM_BEGIN)) == 0){
        strcpy(objName,erisAudioInputI2SHex::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        ...
        strncmp(gPM_BEGIN,m,sizeof(gPM_BEGIN)) == 0){
        strcpy(objName,erisAudioInputI2SOct::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        ...
        strncmp(gPM_BEGIN,m,sizeof(gPM_BEGIN)) == 0){
        strcpy(objName,erisAudioInputI2SQuad::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        ...
        strncmp(gPM_BEGIN,m,sizeof(gPM_BEGIN)) == 0){
        strcpy(objName,erisAudioInputPDM::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        ...
        strncmp(gPM_BEGIN,m,sizeof(gPM_BEGIN)) == 0){
        strcpy(objName,erisAudioInputPDM2::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        ...
        strncmp(gPM_BEGIN,m,sizeof(gPM_BEGIN)) == 0){
        strcpy(objName,erisAudioInputSPDIF3::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        ...
        strncmp(gPM_BEGIN,m,sizeof(gPM_BEGIN)) == 0){
        strcpy(objName,erisAudioInputTDM::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        ...
        strncmp(gPM_BEGIN,m,sizeof(gPM_BEGIN)) == 0){
        strcpy(objName,erisAudioInputTDM2::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        ...
        strcpy(objName,erisAudioMixer4::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        erisAudioMixer4* eac = (erisAudioMixer4*) (ad->getAudioStreamObjByName(objName));
        if (eac != NULL){
			uint32_t channel;
			float gain;
            total_read = sscanf(p, "%f,%f" , channel,gain); // ['uint32_t channel', 'float gain']
        ...
        strncmp(gPM_GAIN,m,sizeof(gPM_GAIN)) == 0){
        strcpy(objName,erisAudioAmplifier::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        ...
        strncmp(gPM_BEGIN,m,sizeof(gPM_BEGIN)) == 0){
        strcpy(objName,erisAudioOutputADAT::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        ...
        strncmp(gPM_BEGIN,m,sizeof(gPM_BEGIN)) == 0){
        strcpy(objName,erisAudioOutputAnalog::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        ...
        strncmp(gPM_BEGIN,m,sizeof(gPM_BEGIN)) == 0){
        strcpy(objName,erisAudioOutputAnalogStereo::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        ...
        strncmp(gPM_BEGIN,m,sizeof(gPM_BEGIN)) == 0){
        strcpy(objName,erisAudioOutputI2S::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        ...
        strncmp(gPM_BEGIN,m,sizeof(gPM_BEGIN)) == 0){
        strcpy(objName,erisAudioOutputI2Sslave::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        ...
        strncmp(gPM_BEGIN,m,sizeof(gPM_BEGIN)) == 0){
        strcpy(objName,erisAudioOutputI2S2::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        ...
        strncmp(gPM_BEGIN,m,sizeof(gPM_BEGIN)) == 0){
        strcpy(objName,erisAudioOutputI2S2slave::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        ...
        strncmp(gPM_BEGIN,m,sizeof(gPM_BEGIN)) == 0){
        strcpy(objName,erisAudioOutputI2SHex::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        ...
        strncmp(gPM_BEGIN,m,sizeof(gPM_BEGIN)) == 0){
        strcpy(objName,erisAudioOutputI2SOct::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        ...
        strncmp(gPM_BEGIN,m,sizeof(gPM_BEGIN)) == 0){
        strcpy(objName,erisAudioOutputI2SQuad::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        ...
        strncmp(gPM_BEGIN,m,sizeof(gPM_BEGIN)) == 0){
        strcpy(objName,erisAudioOutputMQS::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        ...
        strncmp(gPM_BEGIN,m,sizeof(gPM_BEGIN)) == 0){
        strcpy(objName,erisAudioOutputPT8211::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        ...
        strncmp(gPM_BEGIN,m,sizeof(gPM_BEGIN)) == 0){
        strcpy(objName,erisAudioOutputPT8211_2::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        ...
        strncmp(gPM_BEGIN,m,sizeof(gPM_BEGIN)) == 0){
        strcpy(objName,erisAudioOutputPWM::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        ...
        if (eac != NULL){
			uint8_t pin1;
			uint8_t pin2;
            total_read = sscanf(p, "%d,%d" , pin1,pin2); // ['uint8_t pin1', 'uint8_t pin2']
            eac->begin(pin1,pin2);
        }
    }else if(strncmp(gPC_ERISAUDIOOUTPUTSPDIF,c,sizeof(gPC_ERISAUDIOOUTPUTSPDIF)) == 0 &&\
        strncmp(gPM_BEGIN,m,sizeof(gPM_BEGIN)) == 0){
        strcpy(objName,erisAudioOutputSPDIF::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        ...
        strncmp(gPM_BEGIN,m,sizeof(gPM_BEGIN)) == 0){
        strcpy(objName,erisAudioOutputSPDIF2::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        ...
        strncmp(gPM_BEGIN,m,sizeof(gPM_BEGIN)) == 0){
        strcpy(objName,erisAudioOutputSPDIF3::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        ...
        strncmp(gPM_BEGIN,m,sizeof(gPM_BEGIN)) == 0){
        strcpy(objName,erisAudioOutputTDM::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        ...
        strncmp(gPM_BEGIN,m,sizeof(gPM_BEGIN)) == 0){
        strcpy(objName,erisAudioOutputTDM2::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        ...
        strncmp(gPM_STOP,m,sizeof(gPM_STOP)) == 0){
        strcpy(objName,erisAudioPlayMemory::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        ...
        strcpy(objName,erisAudioPlayQueue::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        erisAudioPlayQueue* eac = (erisAudioPlayQueue*) (ad->getAudioStreamObjByName(objName));
        if (eac != NULL){
			int16_t data;
            total_read = sscanf(p, "%d" , data); // ['int16_t data']
            eac->play(data);
        }
    }else if(strncmp(gPC_ERISAUDIOPLAYQUEUE,c,sizeof(gPC_ERISAUDIOPLAYQUEUE)) == 0 &&\
        strncmp(gPM_AVAILABLE,m,sizeof(gPM_AVAILABLE)) == 0){
        ...
        strncmp(gPM_BEGIN,m,sizeof(gPM_BEGIN)) == 0){
        strcpy(objName,erisAudioPlaySdRaw::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        ...
        strncmp(gPM_BEGIN,m,sizeof(gPM_BEGIN)) == 0){
        strcpy(objName,erisAudioPlaySdWav::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        ...
        if (eac != NULL){
			uint32_t size;
            total_read = sscanf(p, "%f" , size); // ['uint32_t size']
            eac->consume(size);
        }
    }else if(strncmp(gPC_ERISAUDIOPLAYSDWAV,c,sizeof(gPC_ERISAUDIOPLAYSDWAV)) == 0 &&\
        ...
        strncmp(gPM_BEGIN,m,sizeof(gPM_BEGIN)) == 0){
        strcpy(objName,erisAudioPlaySerialflashRaw::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        ...
        strncmp(gPM_CONFIGURE,m,sizeof(gPM_CONFIGURE)) == 0){
        strcpy(objName,erisQuantizer::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        ...
        if (eac != NULL){
			...
			bool dither;
			float factor;
            total_read = sscanf(p, "%d,%d,%f" , noiseShaping,dither,factor); // ['bool noiseShaping', 'bool dither', 'float factor']
        ...
        strncmp(gPM_BEGIN,m,sizeof(gPM_BEGIN)) == 0){
        strcpy(objName,erisAudioRecordQueue::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        ...
        strncmp(gPM_RESET,m,sizeof(gPM_RESET)) == 0){
        strcpy(objName,erisResampler::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        ...
        if (eac != NULL){
			float beta;
			int32_t noSamples;
            total_read = sscanf(p, "%f,%f" , beta,noSamples); // ['float beta', 'int32_t noSamples']
        ...
        if (eac != NULL){
			...
			float cutOffFrequ;
			float kaiserBeta;
            total_read = sscanf(p, "%f,%f,%f,%f" , halfFiltLength,overSampling,cutOffFrequ,kaiserBeta); // ['int32_t halfFiltLength', 'int32_t overSampling', 'float cutOffFrequ', 'float kaiserBeta']
        ...
        strcpy(objName,erisAudioSynthWaveformDc::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        ...
        strncmp(gPM_NOTEON,m,sizeof(gPM_NOTEON)) == 0){
        strcpy(objName,erisAudioSynthKarplusStrong::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        ...
        strncmp(gPM_AMPLITUDE,m,sizeof(gPM_AMPLITUDE)) == 0){
        strcpy(objName,erisAudioSynthNoisePink::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        ...
        strncmp(gPM_FREQUENCY,m,sizeof(gPM_FREQUENCY)) == 0){
        strcpy(objName,erisAudioSynthWaveformPWM::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        ...
        strncmp(gPM_NOTEON,m,sizeof(gPM_NOTEON)) == 0){
        strcpy(objName,erisAudioSynthSimpleDrum::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        ...
        if (eac != NULL){
            ...
            total_read = sscanf(p, "%f" , milliseconds); // ['int32_t milliseconds']
        ...
        strncmp(gPM_FREQUENCY,m,sizeof(gPM_FREQUENCY)) == 0){
        strcpy(objName,erisAudioSynthWaveformSine::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        ...
        strncmp(gPM_FREQUENCY,m,sizeof(gPM_FREQUENCY)) == 0){
        strcpy(objName,erisAudioSynthWaveformSineHires::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        ...
        strncmp(gPM_FREQUENCY,m,sizeof(gPM_FREQUENCY)) == 0){
        strcpy(objName,erisAudioSynthWaveformSineModulated::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        ...
        strncmp(gPM_PLAY,m,sizeof(gPM_PLAY)) == 0){
        strcpy(objName,erisAudioSynthToneSweep::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        ...
        strncmp(gPM_FREQUENCY,m,sizeof(gPM_FREQUENCY)) == 0){
        strcpy(objName,erisAudioSynthWaveform::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        ...
        strncmp(gPM_FREQUENCY,m,sizeof(gPM_FREQUENCY)) == 0){
        strcpy(objName,erisAudioSynthWaveformModulated::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        ...
        strncmp(gPM_AMPLITUDE,m,sizeof(gPM_AMPLITUDE)) == 0){
        strcpy(objName,erisAudioSynthWavetable::short_name);
        strcpy(objName,"_");strcpy(objName,i);
        ...
        strncmp(gPM_AMPLITUDE,m,sizeof(gPM_AMPLITUDE)) == 0){
        strcpy(objName,erisAudioSynthNoiseWhite::short_name);
        strcpy(objName,"_");strcpy(objName,i);
